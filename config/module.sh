...
# Enable print privacy log:
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-privacy_log"
...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-decoder=eac3_mediacodec"
