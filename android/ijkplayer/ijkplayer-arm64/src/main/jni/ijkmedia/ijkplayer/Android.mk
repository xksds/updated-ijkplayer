...
LOCAL_CFLAGS += -DFFMPEG_UPDATED=1
LOCAL_CXXFLAGS += -DFFMPEG_UPDATED=1
...
ifeq (1,$(FFMPEG_UPDATED))
else
#LOCAL_CFLAGS += -std=c99
endif
LOCAL_LDLIBS += -llog -landroid

LOCAL_CFLAGS += -Wno-asm-operand-widths -Wno-deprecated-declarations -Wno-implicit-function-declaration \
				-Wno-int-to-pointer-cast -Wno-unused-variable -Wno-int-conversion -Wno-unused-function \
